 ...
 */
export function Sidebar({ id, hidden = false }: { id?: string; hidden?: boolean }): ReactNode {
  ...
  return (
    <aside id={id} className="sidebar" data-testid="sidebar" aria-label="session" hidden={hidden}>
